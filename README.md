...
- [code-scope-gate](skills/code-scope-gate/SKILL.md): Cross-workflow scope triage before planning, coding, debugging, review, or automation; separate requested outcomes, candidate implementations, ambiguous intended scope, and boundary changes, then delete unnecessary surface and choose the next authorized action.
