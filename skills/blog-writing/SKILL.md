...
2. **确认写作意图** — 问用户：这篇文章想让读者带走什么？（一句话）。同时确认目标读者是谁（见下方"读者画像"）
3. **拟定结构大纲** — 按下方的结构框架组织，先给用户看大纲，确认后再写
4. **写初稿** — 按大纲展开，遵循下方所有写作原则
...
1. **通读全文** — 不带预设地读一遍
2. **模拟首次读者** — 逐段标注：读者此刻知道什么、期待什么、实际读到什么
3. **输出诊断报告** — 按诊断清单逐项检查，给出具体问题和修改建议
4. **提供修改方案** — 可以是结构调整建议（大纲级别），也可以是逐段改写

## 读者画像

读者画像不是固定的，需要根据文章的话题和发布渠道来确定。在开始写作或诊断之前，先明确两件事：

1. **核心读者是谁？** 占大多数的那群人。技术博客的核心读者可能是工程师，产品博客可能是产品经理，个人成长博客可能是同龄的职场人。
2. **外围读者是谁？** 可能感兴趣但专业背景不同的人。

如果用户没有指定读者画像，根据文章内容推断一个合理的画像，并向用户确认。
